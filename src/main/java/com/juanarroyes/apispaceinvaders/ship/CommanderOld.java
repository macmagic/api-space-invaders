...
public class CommanderOld {
    ...
    public CommanderOld(String[][] maze, Area area, Coordinates actualPosition, Coordinates lastPosition, boolean fire, List<Coordinates> pathUsed) {
        this.maze = maze;
        this.area = area;
